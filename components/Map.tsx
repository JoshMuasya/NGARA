...
const AfricaMap = () => {
    ...
    const handleCountryClick = (countryName: any) => {
    ...
    return (
        <div className="w-full">
            {/* <div className="z-20 w-full">
                <button onClick={handleZoomIn} className="pr-10 text-3xl">
                    +
                </button>
                <button onClick={handleZoomOut} className="text-3xl">
                    -
                </button>
            </div> */}
            <div className="">
                ...
                >
                    ...
                    <path
                        ...
                        onMouseEnter={(event) =>
                            handleCountryHover(event, "ivory_coast")
                        }
                        onMouseLeave={(event) =>
                            handleCountryHoverEnd(event)
                        }
                        onClick={() => handleCountryClick("ivory_coast")}
                        cursor="pointer">
                        <title>Cote d'Ivore</title>
                    </path>
                    <path
                        id="Gambia"
                        style={{
                    ...
                    <path
                        ...
                        id="Kenya"
                        onMouseEnter={(event) => handleCountryHover(event, "Kenya")}
                        onMouseLeave={(event) => handleCountryHoverEnd(event)}
                    ...
                    <path
                        ...
                        id="Simbabwe"
                        onMouseEnter={(event) => handleCountryHover(event, "Zimbabwe")}
                        onMouseLeave={(event) => handleCountryHoverEnd(event)}
                        onClick={() => handleCountryClick("Zimbabwe")}
                        cursor="pointer">
                        <title className='bg-white text-accent'>Zimbabwe</title>
                    </path>
                    <path
                        id="Somalia"
                        style={{
                    ...
                    <path
                        ...
                        onMouseEnter={(event) => handleCountryHover(event, "South Sudan")}
                        onMouseLeave={(event) => handleCountryHoverEnd(event)}
                        onClick={() => handleCountryClick("South Sudan")}
                        cursor="pointer">
                        <title className='bg-white text-accent'>South Sudan</title>
                    </path>
                    <path
                        id="Sudan"
                        style={{
                    ...
                    <path
                        ...
                        id="Tanzania"
                        onMouseEnter={(event) => handleCountryHover(event, "Tanzania")}
                        onMouseLeave={(event) => handleCountryHoverEnd(event)}
                    ...
                    <path
                        ...
                        id="Uganda"
                        onMouseEnter={(event) => handleCountryHover(event, "Uganda")}
                        onMouseLeave={(event) => handleCountryHoverEnd(event)}
